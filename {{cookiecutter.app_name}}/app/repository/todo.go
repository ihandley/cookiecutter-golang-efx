...
import (
	...
	"midigator-portfolios/cookiecutter-golang/app/models"
...
type TodoRepo interface {
	Save(ctx context.Context, tx pgx.Tx, doc *models.Todo) error
	FindOne(ctx context.Context, tx pgx.Tx, doc models.Todo) (models.Todo, error)
	Update(ctx context.Context, tx pgx.Tx, doc *models.Todo, fieldsToUpdate []string) error
	FindAll(ctx context.Context, tx pgx.Tx, query models.TodoQuery) ([]models.Todo, int64, error)
}
...
func (repo *todoRepo) Save(ctx context.Context, tx pgx.Tx, doc *models.Todo) error {
	groupError := "SAVE_TODO"
	if _, err := tx.Exec(ctx,
		"INSERT INTO todo (id) VALUES (1)"); err != nil {
		return err
	}
...
func (repo *todoRepo) FindOne(ctx context.Context, tx pgx.Tx, doc models.Todo) (models.Todo, error) {
...
func (repo *todoRepo) Update(ctx context.Context, tx pgx.Tx, doc *models.Todo, fieldsToUpdate []string) error {
...
func (repo *todoRepo) FindAll(ctx context.Context, tx pgx.Tx, query models.TodoQuery) ([]models.Todo, int64, error) {
...
func NewTodoRepo(db *pgx.Conn) TodoRepo {
	return &todoRepo{
		db: db,
	}
}
